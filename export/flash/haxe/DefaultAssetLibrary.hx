...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/data/map.tmx", Reflect.field (AssetType, "binary".toUpperCase ()));
...
class __ASSET__assets_data_map_tmx extends flash.utils.ByteArray { }
class __ASSET__assets_data_tilesheet_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
